...
<body style="background-color:rgb(192,192,192); padding-top:8%;">
...
<nav class="navbar navbar-expand-lg navbar-light bg-dark fixed fixed-top"
    ...
    <center>
        ...
        <div class="container" style="margin-top:2%;">
            <div
                style="width:80%; background-color:rgba(0,255,0,.5); padding:5px 5px 5px 5px; border-radius:15px; box-shadow: 3px 3px 10px gray;">
